...
def encode_from_string(content, chunk_size=1000, chunk_overlap=200):
    ...
    try:
        ...
        #embeddings = OpenAIEmbeddings()
        # Use HuggingFace instead of OpenAIEmbeddings
...
def get_langchain_embedding_provider(provider: EmbeddingProvider, model_id: str = None):
    ...
    # Add HuggingFace as a free provider
    elif provider == "huggingface":
        from langchain_huggingface import HuggingFaceEmbeddings
        return HuggingFaceEmbeddings(model_name=model_id if model_id else "BAAI/bge-small-en-v1.5")
